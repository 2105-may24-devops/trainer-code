...
(
    ...
    -- 4 digits total, 2 after the decimal point
	...
	CONSTRAINT pk_reviews_id PRIMARY KEY
    (id),
		-- name of constraint, type of constraint, list of columns in the PK
	CONSTRAINT chk_reviews_score_min_0 CHECK
    (score >= 0),
	CONSTRAINT u_reviews_reviewer_restaurant UNIQUE
    (restaurant_id, reviewer)
);

    --ALTER TABLE reviews DROP CONSTRAINT chk_reviews_score_min_0;
    ...
    (
        ...
        opening_time TIME
        WITHOUT TIME ZONE NULL DEFAULT
        ('9:00 AM'),
	closing_time TIME WITHOUT TIME ZONE NULL DEFAULT
        ('11:00 PM'),
	CONSTRAINT pk_restaurants_id PRIMARY KEY
        (id)
);
